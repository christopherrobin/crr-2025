    ...
    <PageLayout maxWidth="narrow">
      <div className="space-y-8">
        ...
        <section>
          ...
          <div>
            <p>Archived Personal projects available at <a href="https://github.com/christopherrobin/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://github.com/christopherrobin/</a></p>
          </div>
        </section>
