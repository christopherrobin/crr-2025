      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <p className="mb-6">
                Feel free to get in touch if you like talking about technology.
              </p>
              
              <div className="space-y-4">
                <a
                  href="mailto:christopher@spaceagebrains.com"
                  className="flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg transition-colors"
                >
